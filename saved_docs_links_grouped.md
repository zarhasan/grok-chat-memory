# Saved Documentation Links - Grouped

> **Note**: This is a grouped version of your saved docs links for easier navigation in Obsidian or any Markdown viewer. Original flat list is also available in `saved_docs_links.md`.
...
## 5. Original Flat List
(See the companion file `saved_docs_links.md` for the original ungrouped version.)
